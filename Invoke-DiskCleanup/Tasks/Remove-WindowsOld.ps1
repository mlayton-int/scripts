...
.DESCRIPTION
    ...
    Outputs
      C:\ProgramData\Kaseya\Logs\DiskCleanup_WindowsOld.log
      C:\ProgramData\Kaseya\Logs\DiskCleanup_WindowsOld_Summary.json
      C:\ProgramData\Kaseya\ScriptResult_DiskCleanup_WindowsOld.txt
