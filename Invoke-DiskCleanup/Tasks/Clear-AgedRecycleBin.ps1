...
.DESCRIPTION
    ...
    Outputs
      C:\INS-Temp\Logs\DiskCleanup_RecycleBin.log
      C:\INS-Temp\Logs\DiskCleanup_RecycleBin_Summary.json
      C:\INS-Temp\Logs\ScriptResult_DiskCleanup_RecycleBin.txt
...
.PARAMETER Delete
    Actually delete. Omitted, the script measures what would be removed and deletes
