...
.DESCRIPTION
    ...
    Outputs
      C:\ProgramData\Kaseya\Logs\DiskCleanup_ComponentCleanup.log
      C:\ProgramData\Kaseya\Logs\DiskCleanup_ComponentCleanup_Summary.json
      C:\ProgramData\Kaseya\ScriptResult_DiskCleanup_ComponentCleanup.txt
