...
```
C:\ProgramData\Kaseya\Logs\DiskCleanup_<Task>.log
C:\ProgramData\Kaseya\Logs\DiskCleanup_<Task>_Summary.json
C:\ProgramData\Kaseya\ScriptResult_DiskCleanup_<Task>.txt
```
...
`C:\ProgramData\Kaseya\ScriptResult_DiskCleanup_<Task>.txt`, or branch on the exit code.
